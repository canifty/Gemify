...
let allGemstones: [Gemstone] = [
    Gemstone(name: "Diamond", recipe: [.carbon], modelFileName: "Diamondtest"),
    Gemstone(name: "Sapphire", recipe: [.aluminum, .oxygen], modelFileName: "Sapphire"),
    Gemstone(name: "Opal", recipe: [.hydrogen, .oxygen, .silicon], modelFileName: "Opal"),
    Gemstone(name: "Alexandrite", recipe: [.aluminum, .beryllium, .oxygen], modelFileName: "Alexandrite"),
    Gemstone(name: "Emerald", recipe: [.aluminum, .beryllium, .oxygen, .silicon], modelFileName: "Emerald"),
    Gemstone(name: "Aquamarine", recipe: [.aluminum, .beryllium, .oxygen, .silicon], modelFileName: "Aquamarine"),
    Gemstone(name: "Garnet", recipe: [.aluminum, .magnesium, .oxygen, .silicon], modelFileName: "Garnet"),
    Gemstone(name: "Spinel", recipe: [.aluminum, .magnesium, .oxygen], modelFileName: "Spinel"),
    Gemstone(name: "Topaz", recipe: [.aluminum, .fluorine, .hydrogen, .oxygen, .silicon], modelFileName: "Topaz"),
    Gemstone(name: "Turquoise", recipe: [.aluminum, .hydrogen, .oxygen, .phosphorus, .copper], modelFileName: "Turquoise"),
    Gemstone(name: "Zircon", recipe: [.oxygen, .silicon, .zirconium], modelFileName: "Zircon"),
    Gemstone(name: "Tourmaline", recipe: [.aluminum, .boron, .fluorine, .hydrogen, .lithium, .oxygen, .silicon, .sodium], modelFileName: "Tourmaline")
]
